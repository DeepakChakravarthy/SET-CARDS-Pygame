...
def dc ():
    ...
    card1_violet_star = pygame.image.load("card 1 star violet.PNG").convert()
    ...
    Note = font.render(" Find a Set Cards ",True,(255,255,255))
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if pressed1 and b.collidepoint(pos):
                if (c1 == 1 and c6 ==1 and c2 == 1)or(c == 1 and c5 == 1 and c7 == 1): 
